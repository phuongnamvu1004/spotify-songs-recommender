<template>
  <div>
    ...
    <div class="p-5 relative z-10">
      ...
      <div
        v-if="
          userPreferences.artists.length > 0 ||
          userPreferences.acousticness !== null
        "
      ...
      >
        ...
        <div v-if="userPreferences.artists.length > 0" class="mb-3">
          ...
          <div class="flex flex-wrap gap-2">
            <span
              v-for="(artist, index) in userPreferences.artists"
              :key="index"
        ...
        <div v-if="userPreferences.acousticness !== null" class="mb-1">
          ...
          <span
            class="px-3 py-1 bg-blue-900 text-blue-200 rounded-full text-sm"
          >
            {{
              userPreferences.acousticness === true
                ? "Include instruments"
                : "No instruments"
            }}
          </span>
      ...
      <div v-else>
        ...
        <div v-if="!selectedArtist && !selectedPlaylist">
          ...
          >
            <div
              v-for="(artist, index) in artistAlbums"
              :key="index"
            ...
            >
              ...
              >
                <img
                  v-for="(song, i) in artist.songs.slice(0, 4)"
                  :key="i"
              ...
              <div class="text-white">
                ...
                <div class="flex flex-wrap gap-1 mt-2">
                  <span
                    class="text-xs px-2 py-1 rounded-full bg-purple-900 text-purple-200"
                    >Artist</span
                  >
                  <span
        ...
        <div v-if="selectedArtist && !selectedPlaylist">
          ...
          <div
            class="relative w-full h-48 md:h-64 bg-gradient-to-b from-gray-800 to-gray-900 mb-4 overflow-hidden"
          >
            <div
              v-if="selectedArtist.songs.length < 4"
              class="w-full h-full opacity-50"
            >
              <img
                :src="selectedArtist.songs[0]?.imgURL || '/default-track.png'"
                class="w-full h-full object-cover"
            ...
            <div v-else class="w-full h-full opacity-50 flex">
              <img
                v-for="(song, i) in selectedArtist.songs.slice(0, 4)"
                :key="i"
                :src="song.imgURL || '/default-track.png'"
            ...
            <div
              class="absolute bottom-0 left-0 p-4 md:p-6 w-full bg-gradient-to-t from-gray-900 to-transparent"
            >
              <h2 class="text-white text-3xl font-bold">
                {{ selectedArtist.artist }}
              </h2>
              <p class="text-gray-400 mt-1">
                {{ selectedArtist.songs.length }} recommended songs •
                {{ formatArtistDuration(selectedArtist) }}
              </p>
            </div>
          </div>
          ...
          <div
            v-if="selectedArtist.songs.some((s) => s.preview_url)"
            class="mt-6 bg-gray-800/30 rounded-lg p-4"
          >
            <h3 class="text-white text-xl font-bold mb-4">Preview Tracks</h3>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div
                v-for="(song, index) in selectedArtist.songs.filter(
                  (s) => s.preview_url
                )"
                :key="`preview-${index}`"
          ...
          >
            ...
            <div class="md:ml-6 mt-4 md:mt-0">
              ...
              <p class="text-gray-400 mt-2">
                {{
                  selectedPlaylist.tracks ? selectedPlaylist.tracks.total : 0
                }}
                tracks
              </p>
        ...
        <div
          v-if="artistAlbums.length === 0 && playlists.length === 0"
