            ...
            <div class="flex justify-between mb-2">
              <span class="text-gray-400"
                ...
                <span class="text-gray-200 font-medium"
                  >{{ Math.min(year1, year2) }} -
                  {{ Math.max(year1, year2) }}</span
                ></span
              >
            </div>
          ...
          <div class="mb-8">
            <div class="flex justify-between mb-2">
              <span class="text-gray-400"
                ...
                <span class="text-gray-200 font-medium"
                  ...
                  {{ formatDuration(Math.max(duration1, duration2)) }}</span
                ></span
              >
            </div>
            ...
            <div class="relative mt-8 mb-16">
              ...
              <div
                ...
                :style="{
                  left:
                    ((Math.min(duration1, duration2) - 60) / 360) * 100 + '%',
              ...
              <div class="year-markers">
                <div
                  v-for="duration in durationMarkers"
                  :key="duration"
                  class="year-marker"
          ...
          <div class="mb-8">
            <div class="flex justify-between mb-2">
              <span class="text-gray-400"
                >Selected tempo:
                <span class="text-gray-200 font-medium"
                  >{{ Math.min(tempo1, tempo2) }} -
                  {{ Math.max(tempo1, tempo2) }} BPM</span
                ></span
              >
            </div>
...
export default {
  ...
  methods: {
    ...
    async submitAnswers() {
      ...
      const answers = {
        yearRange: [
          Math.min(this.year1, this.year2),
          Math.max(this.year1, this.year2),
        ],
        durationRange: [
        ...
        tempoRange: [
          Math.min(this.tempo1, this.tempo2),
          Math.max(this.tempo1, this.tempo2),
        ],
      };
    ...
    onDrag(event) {
      if (!this.isDragging || !this.currentDragTarget || !this.activeContainer)
        return;
