...
from recommender.fetch_data import fetch_user_playlists, fetch_playlist_tracks

# Get the access token from command line arguments
def recommender(access_token, preferences):
    ...
    df = pd.read_csv("spotify_data.csv").sample(1000)
    ...
    user_playlists = fetch_user_playlists(access_token)
    ...
    def create_necessary_outputs(playlist_name, id_dic, df):
        ...
        tracks = fetch_playlist_tracks(access_token, playlist_id)['items']
    ...
    return top50.to_json(orient="records")
