<template>
    <div>
      ...
      <div class="relative z-10 mx-auto max-w-3xl">
        <div class="mb-8">
          <h2 class="text-2xl text-gray-300" id="question-number">Question 4</h2>
          <h1
            ...
            id="question-text">How often do you listen to music?</h1>
        </div>
        ...
        <div class="mt-6 flex items-center justify-between">
          <button @click="goToPage3" class="text-gray-300 transition-colors hover:text-white" id="skip-button">SKIP</button>
