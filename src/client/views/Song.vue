        ...
        <div class="flex flex-col mb-6">
          ...
          <div class="relative w-full h-48 md:h-64 bg-gradient-to-b from-gray-800 to-gray-900 mb-4 overflow-hidden">
            ...
            <div class="absolute bottom-0 left-0 p-4 md:p-6 w-full bg-gradient-to-t from-gray-900 to-transparent">
              ...
              <p class="text-gray-400 mt-1">{{ selectedArtist.songs.length }} recommended songs • {{
                formatArtistDuration(selectedArtist) }}</p>
            </div>
          </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5">
          <div v-for="playlist in playlists" :key="playlist.id"
            ...
            <div class="text-white">
              ...
              <p class="text-xs text-gray-400 mt-1">By {{ playlist.owner ? playlist.owner.display_name : 'Unknown' }}
              </p>
