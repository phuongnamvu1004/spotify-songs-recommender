<template>
 <div class="relative min-h-screen bg-gray-800 flex items-center justify-between">
   ...
   <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full px-6">
     <h1 class="text-8xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-[#1DB954] to-blue-500 animate-gradient-x">
       Feel The Music
     </h1>
     <p class="text-3xl text-gray-300 mb-10">Stream over 200 thousand songs with one click</p>
    ...
    <div v-else>
      <a href="http://localhost:3000/login" class="text-spotify-white font-bold">Login with Spotify</a>
    </div>
